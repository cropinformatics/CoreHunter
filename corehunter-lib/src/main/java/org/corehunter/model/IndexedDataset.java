...
public interface IndexedDataset<IndexType, ValueType> extends IndexedData<IndexType>, Dataset<ValueType>
{
	...
	public Set<ValueType> getElements(List<IndexType> indices) throws UnknownEntityException ;
	
	public IndexType getIndex(ValueType value) throws UnknownEntityException ;
}
