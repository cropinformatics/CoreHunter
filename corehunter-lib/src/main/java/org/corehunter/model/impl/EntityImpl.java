...
public class EntityImpl implements Entity
{
	...
	public boolean equals(Object object)
	{
		if (object instanceof Entity)
		{
			return super.equals(object)
			    || (getUniqueIdentifier().equals(
			        ((Entity) object).getUniqueIdentifier()) && getName().equals(
			        ((Entity) object).getName()));
		}
		else
		{
			return super.equals(object);
	...
	public int hashCode()
	{
		...
		hash = 89
		    * hash
		    + (getUniqueIdentifier() != null ? getUniqueIdentifier().hashCode() : 0);
		return hash;
	}
